...
@app.callback(
    [
        ...
        Output(app_id_dict['hidden_texture_add_row_time_tab5'], 'children'),
        Output(app_id_dict['texture_table_tab5'], 'data'),
        Output(app_id_dict['texture_checklist_tab5'], 'value'),
        Output(app_id_dict['grain_size_input_tab5'], 'value'),
        Output(app_id_dict['grain_size_checklist_tab5'], 'value'),
    ],
    [
        Input(app_id_dict['cif_upload_tab5'], 'filename'),
        Input(app_id_dict['add_row_tab5'], 'n_clicks_timestamp'),
        Input(app_id_dict['texture_add_row_tab5'], 'n_clicks_timestamp'),
    ],
    [
        ...
        State(app_id_dict['hidden_texture_add_row_time_tab5'], 'children'),
        State(app_id_dict['texture_checklist_tab5'], 'value'),
        State(app_id_dict['texture_table_tab5'], 'data'),
        State(app_id_dict['texture_table_tab5'], 'columns'),
...
# texture checklist
@app.callback([
                Output(app_id_dict['texture_add_row_tab5'], "disabled"),
                Output(app_id_dict['texture_table_tab5'], "editable"),
                ],
              Input(app_id_dict['texture_checklist_tab5'], "value"))
def method(checklist_tab5_value):

    # button is unchecked
    if len(checklist_tab5_value) == 1:
        return True, False
...
@app.callback(
    Output(app_id_dict['grain_size_input_tab5'], "disabled"),
    Input(app_id_dict['grain_size_checklist_tab5'], "value"))
def method_grain_size_tab5(checklist_value):
