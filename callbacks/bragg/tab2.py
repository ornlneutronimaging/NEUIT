...
@app.callback(
    [
        ...
        Output(app_id_dict['hidden_texture_add_row_time_tab2'], 'children'),
        Output(app_id_dict['texture_table_tab2'], 'data'),
        Output(app_id_dict['texture_checklist_tab2'], 'value'),
        Output(app_id_dict['grain_size_input_tab2'], 'value'),
        Output(app_id_dict['grain_size_checklist_tab2'], 'value'),
    ],
    [
        Input(app_id_dict['cif_upload_tab2'], 'filename'),
        Input(app_id_dict['add_row_tab2'], 'n_clicks_timestamp'),
        Input(app_id_dict['texture_add_row_tab2'], 'n_clicks_timestamp'),
    ],
    [
        ...
        State(app_id_dict['hidden_texture_add_row_time_tab2'], 'children'),
        State(app_id_dict['texture_checklist_tab2'], 'value'),
        State(app_id_dict['texture_table_tab2'], 'data'),
        State(app_id_dict['texture_table_tab2'], 'columns'),
...
# texture checklist
@app.callback([
                Output(app_id_dict['texture_add_row_tab2'], "disabled"),
                Output(app_id_dict['texture_table_tab2'], "editable"),
                ],
              Input(app_id_dict['texture_checklist_tab2'], "value"))
def method(checklist_tab2_value):

    # button is unchecked
    if len(checklist_tab2_value) == 1:
        return True, False
...
@app.callback(
    Output(app_id_dict['grain_size_input_tab2'], "disabled"),
    Input(app_id_dict['grain_size_checklist_tab2'], "value"))
def method_grain_size_tab2(checklist_value):
