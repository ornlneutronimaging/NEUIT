...
@app.callback(
    [
        ...
        Output(app_id_dict['hidden_texture_add_row_time_tab3'], 'children'),
        Output(app_id_dict['texture_table_tab3'], 'data'),
        Output(app_id_dict['texture_checklist_tab3'], 'value'),
        Output(app_id_dict['grain_size_input_tab3'], 'value'),
        Output(app_id_dict['grain_size_checklist_tab3'], 'value'),
    ],
    [
        Input(app_id_dict['cif_upload_tab3'], 'filename'),
        Input(app_id_dict['add_row_tab3'], 'n_clicks_timestamp'),
        Input(app_id_dict['texture_add_row_tab3'], 'n_clicks_timestamp'),
    ],
    [
        ...
        State(app_id_dict['hidden_texture_add_row_time_tab3'], 'children'),
        State(app_id_dict['texture_checklist_tab3'], 'value'),
        State(app_id_dict['texture_table_tab3'], 'data'),
        State(app_id_dict['texture_table_tab3'], 'columns'),
...
# texture checklist
@app.callback([
                Output(app_id_dict['texture_add_row_tab3'], "disabled"),
                Output(app_id_dict['texture_table_tab3'], "editable"),
                ],
              Input(app_id_dict['texture_checklist_tab3'], "value"))
def method(checklist_tab3_value):

    # button is unchecked
    if len(checklist_tab3_value) == 1:
        return True, False
...
@app.callback(
    Output(app_id_dict['grain_size_input_tab3'], "disabled"),
    Input(app_id_dict['grain_size_checklist_tab3'], "value"))
def method_grain_size_tab3(checklist_value):
